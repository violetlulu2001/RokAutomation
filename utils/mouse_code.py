...
def join_rally() -> None:
    ...
    time.sleep(3)
    pyautogui.click(city['castle']['settigs_castle']["x"], city['castle']['settigs_castle']["y"], duration=1)
    time.sleep(3)
    pyautogui.click(city['castle']['closet_btn_castle']["x"], city['castle']['closet_btn_castle']["y"], duration=1)
    time.sleep(3)
